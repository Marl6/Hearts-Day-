...
$(function () {
    ...
    backgroundImage.src = 'heartue.png';
    backgroundImage.onload = function() {
  gardenCtx.drawImage(backgroundImage, 20, 0, gardenCanvas.width-63, gardenCanvas.height-65);
};
	$("#content").css("width", $loveHeart.width() + $("#code").width());
	$("#content").css("height", Math.max($loveHeart.height(), $("#code").height()));
	$("#content").css("margin-top", Math.max(($window.height() - $("#content").height()) / 2 - 50, 10));
	$("#content").css("margin-left", Math.max(($window.width() - $("#content").width()) / 2, 60));
